...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/editorconfig-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14390&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/editorconfig-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `editorconfig` can be installed with:

```
conda install editorconfig
```

It is possible to list all of the versions of `editorconfig` available on your platform with:
